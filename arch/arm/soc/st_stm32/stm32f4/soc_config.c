...
static const stm32_pin_func_t pin_pa9_funcs[] = {
	[STM32F4_PINMUX_FUNC_PA9_USART1_TX - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_UP,
};

static const stm32_pin_func_t pin_pa10_funcs[] = {
	[STM32F4_PINMUX_FUNC_PA10_USART1_RX - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_UP,
};
...
static const stm32_pin_func_t pin_pa4_funcs[] = {
	[STM32F4_PINMUX_FUNC_PA4_SPI1_NSS - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pa5_funcs[] = {
	[STM32F4_PINMUX_FUNC_PA5_SPI1_SCK - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pa6_funcs[] = {
	[STM32F4_PINMUX_FUNC_PA6_SPI1_MISO - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pa7_funcs[] = {
	[STM32F4_PINMUX_FUNC_PA7_SPI1_MOSI - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pb12_funcs[] = {
	[STM32F4_PINMUX_FUNC_PB12_SPI2_NSS - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pb13_funcs[] = {
	[STM32F4_PINMUX_FUNC_PB13_SPI2_SCK - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pb14_funcs[] = {
	[STM32F4_PINMUX_FUNC_PB14_SPI2_MISO - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};

static const stm32_pin_func_t pin_pb15_funcs[] = {
	[STM32F4_PINMUX_FUNC_PB15_SPI2_MOSI - 1] = STM32F4X_PIN_CONFIG_AF_PUSH_PULL,
};
