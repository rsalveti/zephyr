...
/** \defgroup Timer module configurations.
*
* @{
*/
#define TICKER_WORKER0_IRQn    (RTC0_IRQn)
#define TICKER_JOB0_IRQn       (SWI4_IRQn)
#define TICKER_WORKER1_IRQn    (SWI5_IRQn)
#define TICKER_JOB1_IRQn       (SWI5_IRQn)

#define TICKER_WORKER0_PRIORITY  (0)
#define TICKER_JOB0_PRIORITY     (0)
#define TICKER_WORKER1_PRIORITY  (2)
#define TICKER_JOB1_PRIORITY     (2)
/**
* @}
*/
