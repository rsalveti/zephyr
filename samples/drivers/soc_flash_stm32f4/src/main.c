...
static const struct flash_map {
	...
	[0] = { .start = 0x00000,  .len = KB(16),},
	[1] = { .start = 0x04000 , .len = KB(16) },
	[2] = { .start = 0x08000 , .len = KB(16) },
	[3] = { .start = 0x0C000 , .len = KB(64) },
	[4] = { .start = 0x1C000 , .len = KB(128) },
	[5] = { .start = 0x3C000 , .len = KB(128) },
	[6] = { .start = 0x5C000 , .len = KB(128) },
};
#else
static const struct flash_map {
	uint32_t start;
	...
	[0] = { .start = 0x0000000 , .len = KB(16) },
	[1] = { .start = 0x0004000 , .len = KB(16) },
	[2] = { .start = 0x0008000 , .len = KB(16) },
	[3] = { .start = 0x000c000 , .len = KB(16) },
	[4] = { .start = 0x0010000 , .len = KB(64) },
	[5] = { .start = 0x0020000 , .len = KB(128) },
	[6] = { .start = 0x0040000 , .len = KB(128) },
	[7] = { .start = 0x0060000 , .len = KB(128) },
};
#endif
